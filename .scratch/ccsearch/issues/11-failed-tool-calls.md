...
Shipped in 99556a7 — --failed CLI flag wires up failure analysis. Status set to `done` retroactively during the tracker-vocabulary cleanup (the work predates the `done` state being added to triage-labels.md).
