...
Shipped in 83e59e0 — distributable ccsearch recall skill. Status set to `done` retroactively during the tracker-vocabulary cleanup (the work predates the `done` state being added to triage-labels.md).
