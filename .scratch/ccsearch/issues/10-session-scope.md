...
Shipped in 9d0bc6f — --session scope searches within one Session. Status set to `done` retroactively during the tracker-vocabulary cleanup (the work predates the `done` state being added to triage-labels.md).
